...
const textStyles = [
  ...
  { name: "Subtitle 1", className: "text-subtitle1", sample: "실시간 경기 상태" },
  { name: "Subtitle 2", className: "text-subtitle2", sample: "팀 라인업" },
  { name: "Body 1", className: "text-body1", sample: "경기 일정과 상태를 확인합니다." },
  { name: "Body 2", className: "text-body2", sample: "최근 업데이트 기준으로 표시됩니다." },
...
export const Scale: Story = {
  render: () => {
    ...
    return <div className="max-w-3xl rounded-xl border bg-card px-4">{rows}</div>;
  },
};
